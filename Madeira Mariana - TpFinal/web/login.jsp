                ...
                <div class="col-lg-6">
                  <div class="p-5">
                    ...
                    <form action="SvLogin" method="POST" class="user">
                      ...
                      <div class="form-group">
                        <input type="password" class="form-control form-control-user validate-input" data-validate="La contraseña es obligatoria" id="" placeholder="Contraseña" name="pass" required>
                      </div>
