            ...
            <div class="row mt-5">
              ...
              <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                  <h1 class="h3 text-gray-800">Habitaciones</h1>
                  <form action="SvNewRoom" method="POST"><a href="newRoom.jsp" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm"><i
                      class="fas fa-plus fa-sm text-white-50"></i> Nueva Habitacion</a></form>
                      ...
                      <table class="table table-hover table-sm" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>$<%=precio%></td>
                            <td>
                              <form name="frmModificarHabitacion" action="SvUpdateRoom" method="POST" style="display:inline">
                                <input type="hidden" name="id" value="<%=id%>" />
                                <button type="submit" style="display:inline" class="btn btn-link nav-link"/><i class="fas fa-fw fa-edit "></i></button>
                              </form>
                            </td>
                            <td>
                              <form name="frmBorrarHabitacion" action="SvDeleteRoom" method="POST" style="display:inline">
                                <input type="hidden" name="id" value="<%=id%>" />
